...
const UploadYourResidenceCertificate = ({ onNext, onBack }: Prop) => {
    ...
    return (
        <View style={{ flex: 1 }}>
            <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', padding: 15, backgroundColor: '#fff' }}>
                <TouchableOpacity style={[styles.backButton, { width: 30 }]} onPress={() => { onBack() }}>
                ...
                <View style={{ flex: 1, flexDirection: 'row' }}>
                    <View style={{ backgroundColor: '#f2f2f2', flex: 1, height: 20, borderRadius: 10, marginEnd: 10 }}>
                        <View style={{ width: '30%', height: 20, backgroundColor: '#fa6400', borderRadius: 10 }}></View>
                    </View>
                    <Text>1/3</Text>
                </View>
            </View>
            <ScrollView contentContainerStyle={styles.container}>
                {/* Header */}
                <Text style={styles.title}>İkametgah Belgenizi Yükleyin</Text>
                <Text style={styles.subtitle}>
                    Lütfen ikamet belgenizi yükleyin. Belgeleriniz gizlilikle korunacaktır.
                </Text>
...
export default UploadYourResidenceCertificate;
